...
var DefaultMetrics = newMetricsDex()

func IncUploadToDex() {
	DefaultMetrics.IncUploadToDex()
}

func IncUploadToRouter() {
	DefaultMetrics.IncUploadToRouter()
}

func IncUploadToEdav() {
	DefaultMetrics.IncUploadToEdav()
}
