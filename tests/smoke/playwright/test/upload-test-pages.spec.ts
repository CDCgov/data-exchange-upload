...
const metadataFilename = resolve(__dirname, '..', 'resources', 'manifests.json');
const metadata: Metadata[] = JSON.parse(readFileSync(metadataFilename).toString());
