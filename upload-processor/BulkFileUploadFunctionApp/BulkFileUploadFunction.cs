...
namespace BulkFileUploadFunctionApp
{
    public class BulkFileUploadFunction
    {
        ...
        private async Task ProcessBlobCreatedEvent(string? blobCreatedUrl)
        {
            ...
            string destinationContainerName = result.Item4;
            Dictionary<string, string> tusFileMetadata = result.Item5;
            // result.destinationId, result.extEvent, result.destinationBlobFilename, result.destinationContainerName, result.tusFileMetadata
