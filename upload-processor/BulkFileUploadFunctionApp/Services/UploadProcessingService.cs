    ...
    public class UploadProcessingService : IUploadProcessingService
    {
        ...
        public async Task<(string, string, string, string, Dictionary<string, string>)> CopyBlobToDex(string? blobCreatedUrl)
        {
            ...
            try
            {
                ...
                return (destinationId, extEvent, destinationBlobFilename, destinationContainerName, tusFileMetadata);
            }
            catch (Exception ex)
            {
        ...
        /// <returns></returns>
        public async Task CopyBlobFromDexToEdavAsync(string sourceContainerName, string sourceBlobFilename, IDictionary<string, string> destinationMetadata)
        {
            try
            {
        ...
        /// <param name="destinationMetadata">Destination metadata to be associated with the blob file</param>
        /// <returns></returns>
        public async Task CopyBlobFromDexToRoutingAsync(string sourceContainerName, string sourceBlobFilename, IDictionary<string, string> destinationMetadata)
        {
            try
            {
